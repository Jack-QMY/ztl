...
import { ViewStyle, View, Text, SafeAreaView, ScrollView } from 'react-native';
import { SvgPath, TypeOfSvgPath } from './SvgPath';

export function SvgIcon(props: {
    name: string[] | keyof TypeOfSvgPath;
    size?: number;
    color?: string;
    scale?: number;
    __debugBG?: string;
    ...
    let n = Array.isArray(props.name) ? props.name : SvgPath[props.name];
